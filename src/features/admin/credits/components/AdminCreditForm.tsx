...
import {
    issueAdminCreditAction,
    type AdminCreditState,
} from "@/features/admin/credits/actions/admin-credits";
...
export default function AdminCreditForm({
    ...
    useEffect(() => {
        ...
        if (state.error) error(state.error, "Credit not issued");
        if (state.success) success(state.success, "Credit issued");
